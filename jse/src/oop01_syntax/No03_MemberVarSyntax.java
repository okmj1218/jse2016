...
*/
/*
멤버변수에 관한 자바 투토리얼의 내용
 - There are several kinds of variables
 - Member variables in a class-there are called fields.
 - Variables in method declaration-there are called parameters.
*/
/*
변수의 종류
 - 클래스 변수(클래스 영역, 클래스가 메모리에 올라갈 때, 가장 먼저 생성)
 - 인스턴스 변수(클래스 영역, 인스턴스 생성시 생성)
 - 로컬 변수(지역변수, 메서드 영역, 변수의 선언은 수행시 생성)
*/
/*
 인스턴스 변수(instance variable)
 -1. 각 인스턴스의 개별적인 저장공간
 -2. 인스턴스 생성후, "참조 변수,인스턴스 변수명"으로 접근
 -3. 인스턴스를 생성항 때 생성되고,참조변수가 없을 때
         가비지 컬렉터에 의해  자동 제거됨.
 */
/*
