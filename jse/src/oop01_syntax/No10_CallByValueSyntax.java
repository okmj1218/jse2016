...
/*
 ...
 - Call By Value 인 경우 값을 전달하면 값을 전송한 원본 변수는 변형이 안된다.
  	 단지, stack 간의 값이 복사된다.
 - Call By Reference 의 경수 참조값(Hash Code)을 전달한 객체는
 	 자신의 참조값이 전달 됨으로서 값의 변화가 발생할 수 있다.
 */
/*
 Call By Reference 참조값의 의한 호출
 - 원본 객체의 데이터가 변경된다.
 	변경을 목적으로 하는 경우 이용된다.
 */
/*
 String 객체의 데이터 전달 유형
 - String 객체는 객체임으로 내부적으로 Call By Reference를 사용하거나
